            ...
            <>
              ...
              <div className="flex-1 p-6 bg-white rounded-lg shadow-lg mb-4 md:mb-0 md:mr-4">
                ...
                {pendingreq.length === 0 ? (
                  ...
                  pendingreq.map((req) => (
                    <div key={req.id} className="mb-6 p-4 border rounded-lg shadow-md hover:shadow-lg transition-shadow">
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          <p className="font-medium text-lg text-blue-600">{req.user.username}</p>
                          <p className="text-gray-600 font-medium">{req.service.name}</p>
                        </div>
                        <div className="text-right">
                          <p className="text-sm text-gray-500">
                            Booking Date: {new Date(req.bookingDate).toLocaleDateString()}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-3">
                        <div>
                          <p className="text-gray-500">Price per Hour: 
                            <span className="font-medium text-gray-700"> ${req.service.price}</span>
                          </p>
                          <p className="text-gray-500">Duration: 
                            <span className="font-medium text-gray-700"> {req.service.duration} hours</span>
                          </p>
                        </div>
                        <div className="text-right">
                      ...
                      {req.notes && (
                        <div className="mb-4 p-3 bg-gray-50 rounded-md">
                          <p className="text-gray-600 italic">Notes: {req.notes}</p>
                        </div>
                      )}
