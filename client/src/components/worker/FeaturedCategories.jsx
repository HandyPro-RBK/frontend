...
import { Wrench, Paintbrush, Plug, Car, Home, Utensils } from "lucide-react"; // Changed to Utensils icon
...
const FeaturedCategories = () => {
  ...
  const categories = [
    ...
    },
    {
      id: 4,
      name: "Outdoor",
      icon: Car, // Using Car as a substitute; consider changing to a garden icon
